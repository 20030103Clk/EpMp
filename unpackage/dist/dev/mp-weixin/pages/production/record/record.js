  ...
  record: {
    getRecords: async (params = {}) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/record/record.vue:115", "Get records API response:", response);
        ...
        common_vendor.index.__f__("error", "at pages/production/record/record.vue:125", "Get records error:", error);
        throw error;
      }
    }
  },
  equipment: {
    getEquipments: async (params = {}) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/record/record.vue:138", "Get equipments API response:", response);
        if (response && (response[1] || response.data)) {
          if (response[1]) {
            return response[1].data;
          } else if (response.data) {
        ...
        common_vendor.index.__f__("error", "at pages/production/record/record.vue:148", "Get equipments error:", error);
        throw error;
      }
    }
  }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: $data.filters.productName,
    c: common_vendor.o(($event) => $data.filters.productName = $event.detail.value, "0f"),
    d: common_vendor.t($data.equipmentFilterIndex === 0 ? "全部设备" : $data.filterDevices[$data.equipmentFilterIndex].name),
    e: common_vendor.o((...args) => $options.onEquipmentFilterChange && $options.onEquipmentFilterChange(...args), "ab"),
    f: $data.equipmentFilterIndex,
    g: $data.filterDevices,
    h: common_vendor.t($data.filters.reportDate || "选择日期"),
    i: $data.filters.reportDate,
    j: common_vendor.o((...args) => $options.onDateChange && $options.onDateChange(...args), "58"),
    k: common_vendor.o((...args) => $options.searchRecords && $options.searchRecords(...args), "17"),
    l: common_vendor.o((...args) => $options.resetFilters && $options.resetFilters(...args), "7b"),
    m: common_vendor.t($options.filteredRecords.length),
    n: common_vendor.f($options.filteredRecords, (record, k0, i0) => {
      return common_vendor.e({
