  ...
  plan: {
    getPlans: async (params = {}) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/plan/plan.vue:148", "Get plans API response:", response);
        ...
        common_vendor.index.__f__("error", "at pages/production/plan/plan.vue:160", "Get plans error:", error);
        throw error;
      }
    },
    createPlan: async (data) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/plan/plan.vue:175", "Create plan API response:", response);
        if (response && (response[1] || response.data)) {
          if (response[1]) {
            return response[1].data;
          } else if (response.data) {
        ...
        common_vendor.index.__f__("error", "at pages/production/plan/plan.vue:187", "Create plan error:", error);
        throw error;
      }
    },
    updatePlan: async (id, data) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/plan/plan.vue:202", "Update plan API response:", response);
        if (response && (response[1] || response.data)) {
          if (response[1]) {
            return response[1].data;
          } else if (response.data) {
        ...
        common_vendor.index.__f__("error", "at pages/production/plan/plan.vue:214", "Update plan error:", error);
        throw error;
      }
    },
    deletePlan: async (id) => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/production/plan/plan.vue:225", "Delete plan API response:", response);
        if (response && (response[1] || response.data)) {
          if (response[1]) {
            return response[1].data;
          } else if (response.data) {
        ...
        common_vendor.index.__f__("error", "at pages/production/plan/plan.vue:237", "Delete plan error:", error);
        throw error;
      }
    }
  }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.addPlan && $options.addPlan(...args), "b8")
  } : {}, {
    e: $data.form.product,
    f: common_vendor.o(($event) => $data.form.product = $event.detail.value, "18"),
    g: $data.form.quantity,
    h: common_vendor.o(($event) => $data.form.quantity = $event.detail.value, "3a"),
    i: common_vendor.o(($event) => $data.form.startDate = $event, "1f"),
    j: common_vendor.p({
      type: "date",
      modelValue: $data.form.startDate
    }),
    k: common_vendor.o(($event) => $data.form.endDate = $event, "9a"),
    l: common_vendor.p({
      type: "date",
      modelValue: $data.form.endDate
    }),
    m: common_vendor.o(($event) => $data.form.status = $event, "e4"),
    n: common_vendor.p({
      label: "状态",
    ...
    o: common_vendor.o(($event) => $data.form.progress = $event, "6b"),
    p: common_vendor.p({
      label: "进度",
    ...
    q: common_vendor.o((...args) => $options.close && $options.close(...args), "f3"),
    r: common_vendor.o((...args) => $options.submitPlan && $options.submitPlan(...args), "89"),
    s: common_vendor.sr("popup", "16b64818-1"),
    t: common_vendor.p({
      type: "center"
    }),
    v: $data.selectedStatus === "all" ? 1 : "",
    w: common_vendor.o(($event) => $data.selectedStatus = "all", "2d"),
    x: $data.selectedStatus === "pending" ? 1 : "",
    y: common_vendor.o(($event) => $data.selectedStatus = "pending", "b5"),
    z: $data.selectedStatus === "processing" ? 1 : "",
    A: common_vendor.o(($event) => $data.selectedStatus = "processing", "ca"),
    B: $data.selectedStatus === "completed" ? 1 : "",
    C: common_vendor.o(($event) => $data.selectedStatus = "completed", "0d"),
    ...
    G: common_vendor.o(($event) => $data.form.progress = $event, "7b"),
    H: common_vendor.p({
      label: "进度",
      localdata: $data.candidates,
      placeholder: "请选择进度",
    ...
    I: common_vendor.o((...args) => $options.close1 && $options.close1(...args), "27"),
    J: common_vendor.o((...args) => $options.saveProgress && $options.saveProgress(...args), "a0"),
    K: common_vendor.sr("editPopup", "16b64818-6"),
    L: common_vendor.p({
      type: "center"
    })
  });
