...
if (!Array) {
  ...
  (_easycom_uni_icons2 + _easycom_uni_search_bar2 + _easycom_uni_popup2)();
}
const _easycom_uni_icons = () => "../../../uni_modules/uni-icons/components/uni-icons/uni-icons.js";
const _easycom_uni_search_bar = () => "../../../uni_modules/uni-search-bar/components/uni-search-bar/uni-search-bar.js";
const _easycom_uni_popup = () => "../../../uni_modules/uni-popup/components/uni-popup/uni-popup.js";
if (!Math) {
  (_easycom_uni_icons + _easycom_uni_search_bar + _easycom_uni_popup)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.addproduct && $options.addproduct(...args), "62")
  } : {}, {
    e: common_vendor.o($options.search, "a2"),
    f: common_vendor.o(_ctx.blur, "c4"),
    g: common_vendor.o(_ctx.focus, "5b"),
    h: common_vendor.o(_ctx.input, "ea"),
    i: common_vendor.o(_ctx.cancel, "ec"),
    j: common_vendor.o($options.clear, "2d"),
    k: common_vendor.o(($event) => $data.searchValue = $event, "5c"),
    l: common_vendor.p({
      focus: true,
      modelValue: $data.searchValue
    }),
    m: common_vendor.t($options.totalInventory),
    n: common_vendor.f($options.filterItems, (item, index, i0) => {
      return common_vendor.e({
    ...
    x: common_vendor.o((...args) => $options.editInventory && $options.editInventory(...args), "3a")
  } : {}, {
    y: common_vendor.o((...args) => $options.closepopup && $options.closepopup(...args), "5f"),
    z: common_vendor.sr("popup", "0bf1e840-2"),
    A: common_vendor.p({
      type: "center"
    }),
    B: $data.newProduct.product,
    C: common_vendor.o(($event) => $data.newProduct.product = $event.detail.value, "b9"),
    D: $data.newProduct.code,
    E: common_vendor.o(($event) => $data.newProduct.code = $event.detail.value, "c0"),
    F: $data.newProduct.currentStock,
    G: common_vendor.o(($event) => $data.newProduct.currentStock = $event.detail.value, "a4"),
    H: $data.newProduct.safeStock,
    I: common_vendor.o(($event) => $data.newProduct.safeStock = $event.detail.value, "15"),
    J: $data.newProduct.location,
    K: common_vendor.o(($event) => $data.newProduct.location = $event.detail.value, "18"),
    L: common_vendor.o((...args) => $options.closeAddPopup && $options.closeAddPopup(...args), "e1"),
    M: common_vendor.o((...args) => $options.submitProduct && $options.submitProduct(...args), "f1"),
    N: common_vendor.sr("addPopup", "0bf1e840-3"),
    O: common_vendor.p({
      type: "center"
    }),
    P: $data.editProduct.product,
    Q: common_vendor.o(($event) => $data.editProduct.product = $event.detail.value, "bd"),
    R: $data.editProduct.code,
    S: common_vendor.o(($event) => $data.editProduct.code = $event.detail.value, "1f"),
    T: $data.editProduct.currentStock,
    U: common_vendor.o(($event) => $data.editProduct.currentStock = $event.detail.value, "4a"),
    V: $data.editProduct.safeStock,
    W: common_vendor.o(($event) => $data.editProduct.safeStock = $event.detail.value, "49"),
    X: $data.editProduct.unit,
    Y: common_vendor.o(($event) => $data.editProduct.unit = $event.detail.value, "1a"),
    Z: $data.editProduct.location,
    aa: common_vendor.o(($event) => $data.editProduct.location = $event.detail.value, "b4"),
    ab: common_vendor.o((...args) => $options.closeEditPopup && $options.closeEditPopup(...args), "64"),
    ac: common_vendor.o((...args) => $options.submitEditProduct && $options.submitEditProduct(...args), "cc"),
    ad: common_vendor.sr("editPopup", "0bf1e840-4"),
    ae: common_vendor.p({
      type: "center"
    })
  });
