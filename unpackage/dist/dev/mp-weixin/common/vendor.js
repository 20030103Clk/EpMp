...
function initRuntimeSocketService() {
  const hosts = "192.168.0.108,192.168.134.1,192.168.220.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_SRovH8";
...
const pages = [
  {
    path: "pages/production/login/login",
    style: {
      navigationBarTitleText: "登录"
    }
  },
  {
    path: "pages/production/home/home",
    style: {
      navigationBarTitleText: "生产管理首页"
    }
  },
  {
    path: "pages/production/plan/plan",
    style: {
      navigationBarTitleText: "生产计划"
    }
  },
  {
    path: "pages/production/execution/execution",
    style: {
      navigationBarTitleText: "工序进度"
    }
  },
  {
    path: "pages/production/profile/profile",
    style: {
      navigationBarTitleText: "个人中心"
    }
  },
  {
    path: "pages/production/quality/quality",
    style: {
      navigationBarTitleText: "质量检验登记"
    }
  },
  {
    path: "pages/production/inventory/inventory",
    style: {
      navigationBarTitleText: "库存管理"
    }
  },
  {
    path: "pages/production/management/management",
    style: {
      navigationBarTitleText: "用户管理"
    }
  },
  {
    path: "pages/production/plans/plans",
    style: {
      navigationBarTitleText: "最近订单"
    }
  },
  {
    path: "pages/production/record/record",
    style: {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.0.108","192.168.134.1","192.168.220.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/28649/Desktop/HBuilderX.4.87.2025121004/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"clk20030103","spaceId":"mp-d992b2d8-c5a3-4df3-ace1-fdc792e63df5","clientSecret":"BH7V2PX2uWFSy7VSanSjAg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__CAE50F3";
} catch (e2) {
