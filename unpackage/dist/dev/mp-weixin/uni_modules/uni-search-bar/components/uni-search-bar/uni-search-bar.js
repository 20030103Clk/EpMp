...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: $props.maxlength,
    g: $props.textColor,
    h: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "51"),
    i: common_vendor.o((...args) => $options.blur && $options.blur(...args), "fd"),
    j: common_vendor.o((...args) => $options.emitFocus && $options.emitFocus(...args), "a0"),
    k: $data.searchVal,
    l: common_vendor.o(($event) => $data.searchVal = $event.detail.value, "87")
  } : {
    ...
    p: common_vendor.o((...args) => $options.clear && $options.clear(...args), "93")
  } : {}, {
    q: $props.radius + "px",
    r: $props.bgColor,
    s: common_vendor.o((...args) => $options.searchClick && $options.searchClick(...args), "7a"),
    ...
    w: common_vendor.o((...args) => $options.cancel && $options.cancel(...args), "b4")
  } : {});
}
